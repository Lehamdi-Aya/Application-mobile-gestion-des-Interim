...
public class ActivityNavigationEmployeur extends AppCompatActivity {

    BottomNavigationView bottomNavigationView;
    private ViewPager viewPager;
    FirstFragment homeFragment;
    SecondFragment dashBoardFragment;
    ThirdFragment notificationFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigation_emplyeur);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        dashBoardFragment = new SecondFragment();
        notificationFragment = new ThirdFragment();
